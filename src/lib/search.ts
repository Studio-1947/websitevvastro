...
const STATIC_PAGES: Array<Omit<SearchDoc, "text">> = [
  ...
  },
  {
    ...
    title: "Products",
    description:
      "Doptor ERP, Aangan and Pharma ERP: digital products made by Studio 1947 in Darjeeling.",
  ...
  },
  {
    ...
    title: "Initiatives",
    description:
      "Local Design initiatives by Studio 1947: Preserving hill heritage through Local Archives and empowering communities through free Workshops.",
    keywords: "initiatives local design local archives community workshops artisans hill youth",
  },
  {
    url: "/sayhello/",
    type: "Page",
  ...
  },
  {
    ...
    description:
      "How Studio 1947 collects, uses and protects your information.",
  ...
  },
  {
    ...
    description:
      "Studio 1947’s policy on fair labour and employment practices.",

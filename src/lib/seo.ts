...
export const DEFAULT_FONT_HREF =
  'https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=Google+Sans:wght@400;500;700&family=Google+Sans+Flex:wght@400..700&display=swap';
